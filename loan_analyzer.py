...
print("The total value of the loans is:", sum_of_all_loans)
...
calculate_pv = calculate_present_value(future_value, remaining_months, annual_discount_rate)

print(f"The present value of the loan is: {calculate_pv}")
